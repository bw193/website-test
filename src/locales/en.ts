export const en = {
  translation: {
    ...
    blog: {
      ...
      metaDescription: "Practical sourcing guides, technology explainers, and OEM/ODM manufacturing insights for LED, smart, bathroom, and custom mirrors.",
      schemaName: "BOLEN Mirror Insights",
      kicker: "Practical guidance from the factory floor",
      titleLead: "Mirror sourcing",
      titleAccent: "insights",
      intro: "Buying guidance, technology explanations, and manufacturing know-how for LED mirrors, smart mirrors, and OEM/ODM programs.",
      ...
      notFoundDescription: "The requested BOLEN insight could not be found.",
      backToJournal: "Back to insights",
      relatedProducts: "Featured in this insight",
      latestHeading: "Latest insights",
      latestIntro: "Filter by topic or browse every published guide.",
      filterLabel: "Filter insights by topic",
      noMoreInTopic: "No additional insights in this view yet.",
      nextStepTitle: "Turn useful insight into a factory-ready specification",
      nextStepDescription: "Compare manufacturing routes, then send dimensions, quantity, market, and required functions for a focused quote.",
      categories: {
        "Buying Guide": "Buying Guide",
        "Bolen Story": "BOLEN Story",
    ...
    videos: {
      ...
      metaDescription: "Watch BOLEN LED mirror videos: smart mirror product demos, 46,800 m² factory tours, quality-control footage and installation guides from a 21-year OEM/ODM mirror manufacturer.",
      kicker: "Video library",
      titleLead: "LED mirror videos:",
      titleAccent: "product demos, factory tours & installation",
      intro: "See how BOLEN LED, smart, vanity and bathroom mirrors are built, tested and installed — short clips shot in our own Jiaxing factory that answer sourcing questions before you specify a product.",
      heroPrimaryCta: "Request a quote",
      heroSecondaryCta: "Browse products",
      stats: {
        videos: "Videos",
        topics: "Topics",
        runtime: "Minutes of footage",
        updated: "Last updated"
      },
      spotlightLabel: "Latest video",
      watchNow: "Watch now",
      libraryHeading: "All videos",
      libraryIntro: "Filter by topic or search the library.",
      resultsCount: "{{count}} videos",
      search: "Search videos...",
      searchLabel: "Search videos",
      clearSearch: "Clear search",
      filterLabel: "Filter videos by topic",
      ...
      notFoundDescription: "The requested BOLEN video could not be found.",
      backToVideos: "Back to videos",
      sidebarKicker: "Specify this mirror",
      ...
      relatedProductsKicker: "From the catalog",
      relatedProducts: "Products in this video",
      relatedVideos: "More videos",
      viewAll: "View all",
      guide: {
        kicker: "Shot in our own factory",
        heading: "What the library covers",
        intro: "Every clip is filmed on BOLEN production units and inside the 46,800 m² Jiaxing plant — no stock footage — so what you see is what ships.",
        demos: {
          title: "Product demos",
      ...
      closing: {
        title: "Seen a mirror you want to specify?",
        desc: "Send us the video or product reference. We reply with OEM/ODM options, MOQ, packaging and lead time — and can film a custom demo of your specification."
      },
      categories: {
    ...
    admin: {
      ...
      blog: {
        ...
        requiredEn: "English is required. Blank translations redirect visitors to the English article URL.",
        englishBodyRequired: "Add English article content before publishing.",
        fieldTitle: "Title",
        ...
        fieldStatus: "Status",
        fieldSlug: "Slug",
        slugHelp: "URL: /insights/keyword-slug — keep it short and stable after publishing",
        fieldCategory: "Category",
        fieldAuthor: "Author",
        fieldPublishedAt: "Publish Date",
        fieldReadingMinutes: "Read (min)",
        fieldCover: "Cover Image (optional)",
        coverOptionalHelp: "Leave blank to use the text-first Insight layout.",
        removeCover: "Remove cover",
        coverInvalidType: "Choose a PNG, JPG, or WEBP image.",
        coverTooLarge: "Cover images must be 8 MB or smaller.",
        coverInvalidUrl: "Enter a complete http:// or https:// image URL.",
      ...
      productForm: {
        seo: {
          ...
          h1: "H1 — page heading",
          help: "Each language has its own settings. Fields show the effective values and are generated from product content until customized. Clear a field and save to restore its automatic value.",
          titleHelp: "Used in the browser tab and SEO title tag. Does not change the product URL.",
          descriptionHelp: "Used in the meta description and the visible introduction below H1.",
          h1Help: "The visible main heading. Independent of the product name used for its URL.",
          automatic: "Automatic",
          custom: "Custom",
          characterCount: "Current: {{count}} characters",
          recommendedLength: "Recommended: {{min}}–{{max}} characters",
          lengthGuidance: "Ranges are editorial guidance, not Google limits. Counts include spaces and punctuation. Search display depends on width; prioritize a clear H1. Longer copy can still be saved.",
          preview: "Search and page preview",
          restore: "Restore automatic values for this language",
          publishHelp: "Saved with Save Product. The public page reads these settings; rebuilding and publishing also updates the static HTML served to search engines.",
          loading: "Loading this language’s current copy…",
          loadError: "Could not load this language. Your edits have been kept.",
          retry: "Retry",
        },
        backToDashboard: "Back to Dashboard",
