      ...
      dashboard: {
        ...
        settings: {
          ...
          ai: {
            ...
            faqTitle: "标准问答",
            faqDescription: "为买家常问问题添加已批准答案。英文答案必填，中文答案可选。",
            ...
            faqTriggersHelp: "每行填写一种问法，共 1–20 条；每条 2–160 个字符，保存时会把大小写或标点差异视为重复并去重。",
            faqTriggersError: "请填写 1 到 20 条不重复的触发短语；每条 2–160 个字符，并至少包含一个文字或数字。",
            faqAnswerEnglish: "英文答案",
