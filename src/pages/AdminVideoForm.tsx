...
async function deriveEmbedThumbnail(url: string): Promise<string> {
...
async function captureVideoFrame(source: File | string): Promise<{ thumbnail: Blob; durationSeconds: number | null }> {
